...
## Live Price Checking
Copy and paste into the terminal:<br><br>
...
The pair can be the user's choice, it does not have to be BTCUSDT. For example, it could be XRPUSDT, TRXUSDT, DOTUSDT, etc <br><br>
